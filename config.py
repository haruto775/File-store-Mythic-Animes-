...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("7722185407:AAE8ZEEa0aQGWlckKcuVv1VXMof-EwmvZyw", "7722185407:AAEvgoIfp9buMXITMRJdEag9xe1nHGeUlAM")
...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "Priyanshu 825")
DB_NAME = os.environ.get("DATABASE_NAME", "mongodb+srv://Priyanshu825:<db_password>@cluster0.cosynkz.mongodb.net/")
